...
<html>
<head>
    <title>My Ratings - Upachar</title>
...
<div class="page">
    ...
    <div class="card">
        <div class="section-title">
            ...
            <a class="btn btn-primary" href="<%=request.getContextPath()%>/rating/add-rating.jsp">Add Rating</a>
        </div>
        ...
        <div style="overflow:auto">
            <table class="table">
                ...
                <c:if test="${empty ratings}">
                    <tr><td colspan="6" class="muted">No ratings found.</td></tr>
                </c:if>
