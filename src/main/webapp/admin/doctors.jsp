...
<div class="main-wrapper">
  ...
  <main class="content">
    ...
    <div class="page-header">
      ...
      <a href="<%= request.getContextPath() %>/addDoctor.jsp" class="btn-action">
    ...
    <div class="filter-tabs">
      ...
      <button class="filter-tab">Cardiology</button>
      <button class="filter-tab">Neurology</button>
      <button class="filter-tab">Pediatrics</button>
      <button class="filter-tab">Orthopedics</button>
    </div>
